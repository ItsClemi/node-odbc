...
class Connection {
    ...
    executeQuery(eFetchOperation, cb, query, ...args) {
        if (exports.enableValidation) {
            ...
            if (eFetchOperation < 0 || eFetchOperation > 1 /* eArray */) {
                throw new Error(`Invalid value range: Expected {${0 /* eSingle */} - ${1 /* eArray */}} : got ${eFetchOperation}`);
            }
        }
        let types = this.validateAndPrepareSqlParameters(...args);
    ...
    validateAndPrepareSqlParameters(...args) {
...
exports.SqlOutput = {
    ...
    asDate(reference, scale) {
        return new SqlOutputParameter(reference, 14 /* eDate */, null, null, scale);
    },
    asTimestamp(reference, scale) {
        return new SqlOutputParameter(reference, 15 /* eTimestamp */, null, null, scale);
    },
    asNumeric(reference, precision, scale) {
        return new SqlOutputParameter(reference, 16 /* eNumeric */, null, precision, scale);
    },
};
...
function transformParameter(it, i) {
    if (i == null) {
        return 0 /* eNull */;
    }
